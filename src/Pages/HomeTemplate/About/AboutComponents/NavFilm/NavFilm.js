                            ...
                            <div className="row tab_detail">
                                <div className="col-sm-12 col-xs-12 nav_input">
                                    <span className="imgReview">
                                        <img src="https://fe-66-final-project.vercel.app/assets/images/avatar.png" alt="..." />
                                    </span>
                                        ...
                                        <div className="reviewcontain_userinfo">
                                            <div className="inforeview">
                                                <div className="inforeviewicon">
                                                    <img src="https://fe-66-final-project.vercel.app/assets/images/111c5808618969de941fed35348111be.jpg" alt="..." />
                                                </div>
                                            ...
                                            <div className="infostar">
                                                ...
                                                <div className="info_iconstar">
                                                    <img className="smallstar" src="https://fe-66-final-project.vercel.app/assets/images/star1.png" alt="..." />
                                                    <img className="smallstar" src="https://fe-66-final-project.vercel.app/assets/images/star1.png" alt="..." />
                                                    <img className="smallstar" src="https://fe-66-final-project.vercel.app/assets/images/star1.png" alt="..." />
                                                    <img className="smallstar" src="https://fe-66-final-project.vercel.app/assets/images/star1.png" alt="..." />
                                                    <img className="smallstar" src="https://fe-66-final-project.vercel.app/assets/images/star1.png" alt="..." />
                                        ...
                                        <div className="row">
                                            <div className="col-sm-12 count">
                                                <div className="iconlike">
                                                    <img src="https://fe-66-final-project.vercel.app/assets/images/like.png" alt="..." />
                                ...
                                <div className="row tab_detail reviewcontain">
                                    <div className="reviewcontain_comment">
                                        <div className="reviewcontain_userinfo">
                                            <div className="inforeview">
                                                <div className="inforeviewicon">
                                                    <img src="https://fe-66-final-project.vercel.app/assets/images/5fd79d9cac62feeb075ae11430416bbf.jpg" alt="..." />
                                                </div>
                                                <div className="inforeviewname">
                                                    <p>Huynhhieu</p>
                                ...
                                <div className="row tab_detail reviewcontain">
                                    <div className="reviewcontain_comment">
                                        <div className="reviewcontain_userinfo">
                                            <div className="inforeview">
                                                <div className="inforeviewicon">
                                                    <img src="https://fe-66-final-project.vercel.app/assets/images/153e0aa4708af0bac63e12b5592d330b.jpg" alt="..." />
                                                </div>
                                                <div className="inforeviewname">
                                                    <p>Mai Nha</p>
                                                    <p className="inforeviewtime"> 1 ngày trước</p>
                                ...
                                <div className="row tab_detail reviewcontain">
                                    <div className="reviewcontain_comment">
                                        <div className="reviewcontain_userinfo">
                                            <div className="inforeview">
                                                <div className="inforeviewicon">
                                                    <img src="https://fe-66-final-project.vercel.app/assets/images/1650d6a4f08e9bbe9afe7bcd26d6c137.jpg" alt="..." />
                                                </div>
                                                <div className="inforeviewname">
                                ...
                                <div className="row tab_detail reviewcontain">
                                    <div className="reviewcontain_comment">
                                        <div className="reviewcontain_userinfo">
                                            <div className="inforeview">
                                                <div className="inforeviewicon">
                                                    <img src="https://fe-66-final-project.vercel.app/assets/images/93a7052a103a9cf4723a55dac2d500ce.jpg" alt="..." />
                                                </div>
                                                <div className="inforeviewname">
                                                    <p>Phương</p>
