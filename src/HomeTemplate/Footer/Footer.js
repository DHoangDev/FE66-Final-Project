                ...
                <div className="wrap-width">
                    <div className="row">
                        <div className="col-sm-4 col-xs-12">
                            ...
                            <div className="row">
                                <div className="col-sm-6 col-xs-6 footer_tittle__detail">
                                    <a href="#">FAQ</a>
                                    <a href="#">Brand Guidelines</a>
                                </div>
                                <div className="col-sm-6 col-xs-12 footer_tittle__detail">
                        ...
                        <div className="col-sm-4 col-xs-12">
                            ...
                            <div className="row">
                                <div className="col-sm-12 col-xs-12 footer_item">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-9 col-xs-12 info_footer">
